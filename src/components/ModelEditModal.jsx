      ...
      <div className="bg-white dark:bg-[#202020] rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="flex items-center">
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              <div className={`w-11 h-6 rounded-full transition-colors duration-200 ${
                formData.enabled ? 'bg-[#171717]' : 'bg-gray-300'
              }`}>
          ...
          {(formData.provider === 'n8n' || formData.model_name === 'goku-saiyan-1') && editingModel && (
            <div className="border-t border-gray-200 dark:border-[#121212] pt-6">
              ...
              {loadingFiles ? (
                ...
                <div className="mt-4 space-y-2">
                  ...
                  {uploadedFiles.map((file, index) => (
                    <div key={file.id || index} className="border border-gray-200 dark:border-[#121212] rounded-lg overflow-hidden">
                      {/* File Header */}
          ...
          <div className="flex justify-end space-x-3 pt-6">
            ...
            <button
              type="submit"
              disabled={saving}
              className="px-4 py-2 bg-[#171717] hover:bg-blue-700 text-white rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
